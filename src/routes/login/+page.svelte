...
<div class="pt-20">
	...
	<form
		...
		bind:this={form}
	>
		<input type="text" name="name" placeholder="Name" class="text-center" autocomplete="username" />
		<input
			type="password"
			name="password"
		...
		<div class="flex flex-row justify-evenly items-center gap-5">
			<input type="submit" value="Register" class="hover:scale-105" />
			<input type="submit" value="Log-In" class="hover:scale-105" />
		</div>
	</form>
</div>
